...
{
    public class AddReturnDialogViewModel : BaseViewModel
    {
        ...
        public AddReturnDialogViewModel(Window dialog)
        {
        ...
        public string DialogTitle => "Add Return";
        ...
        // searches bikes based on input - only shows bikes rented by selected customer
